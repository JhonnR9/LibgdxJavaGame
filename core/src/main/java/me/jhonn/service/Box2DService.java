...
import me.jhonn.Game;
import me.jhonn.configuration.Configuration;
import me.jhonn.entity.Player;
...
public class Box2DService {
    ...
    private static final float WIDTH = Game.WIDTH / 10f; // Width of Box2D world.
    private static final float HEIGHT = Game.HEIGHT / 10f; // Height of Box2D world.
